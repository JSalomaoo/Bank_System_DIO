...
while True:
    ...
    if opcao == "d":
        ...
        if valor > 0:
            ...
            print("Operação falhou! O valor informado é inválido. Por favor, refaça a operação.")
        ...
        if excedeu_saldo:
            ...
            print("Operação falhou! Número de saques diários excedidos. Tente novamente amanhã.")
        ...
        print("Operação inválida, por favor selecionamente novamente uma opção válida.")
